...
Le AI sono modelli matematici, probabilmente dei _"semplici"_ pappagalli stocastici, pertanto parlare di _intelligenza_, _ragionamento_ e _pensiero_ è *improprio*.
--
