...
* Embedding
** Tecnica per trasformare una sequenza di token in un vettore numerico
* Vector store
** Database che permette di effettuare confronti per similarità sugli embedding salvati
--
...
[source,js]
----
include::../assets/code_examples/background.js[lines=200..221]
----
...
--
image::RAG_schema.svg[]
--


== !
* Fase 1 +
Usa la domanda per cercare i documenti più rilevanti 
* Fase 2 +
Usa i documenti recuperati e l'input per produrre la risposta
...
* Privacy by design
* Minori problemi etici e di sicurezza
